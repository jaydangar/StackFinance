...
main(List<String> args) {
  runApp(StackFinanceApp());
}

class StackFinanceApp extends StatelessWidget {
  final ThemeData stackFinanceTheme = ThemeData(
  ...
  Widget build(BuildContext context) {
    setInPortraintModeOnly();
    return MaterialApp(
      theme: stackFinanceTheme,
      home: LoginPage(),
      onGenerateRoute: Routing.generateRoutes,
      initialRoute: Routing.LogInPageRoute,
      debugShowCheckedModeBanner: false,
    );
  }

  void setInPortraintModeOnly() {
